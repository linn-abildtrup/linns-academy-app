// Audit: alle juni-Kickstart-kunder hvis userDoc.aktivtTraeningsprogram
// peger paa et FORKERT forl0bsId eller et programId der ikke matcher
// deres mikrotraeningVariant. F0r vi vidste at hver gang en kunde
// skifter forl0b, skal aktivtTraeningsprogram resynkroniseres.
...
function programIdForVariant(variant: string): string {
	return variant === 'kettlebell' ? 'mikrotraening_kettlebell' : 'mikrotraening_no_kettlebell';
}
