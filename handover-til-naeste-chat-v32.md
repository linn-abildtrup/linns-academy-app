...
## 8. Åbne tråde / TODO
- **Kropsro maj små skridt — kun uge 12 mangler:** uge 8–11 er publiceret (Linn fyldte dem 9.–15/7), så "Dagens små skridt" er fyldt i dag. Eneste udestående er **uge 12** (dag 78–84), der er helt tom og starter ~**9/8** — skal planlægges + publiceres i admin (Forløb → Kropsro → Små skridt) inden da. Scannet 15/7: **SommerRo er fuldt dækket, ingen andre aktive forløb har tomme uger.**
