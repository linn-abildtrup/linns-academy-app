<script lang="ts">
	...
	function aabnGemModal() {
		if (redigererMaaltid) {
			...
			//    dagbogen bagefter (fx 'Æble').
			// 3) Flere ingredienser: fald tilbage til måltidstypens label.
			if (pendingMaaltidsNavn?.trim()) {
				gemNavn = pendingMaaltidsNavn.trim();
